            ...
            <el-disclosure id="mobile-menu" hidden class="block md:hidden">
                ...
                <div class="border-t border-white/10 pt-4 pb-3">
                    <div class="flex items-center px-5">
                        <div class="shrink-0">
                            <img src="https://i.pinimg.com/1200x/35/51/aa/3551aa1febb5d532e2e1909f00c23074.jpg"
                                alt="" class="size-10 rounded-full outline -outline-offset-1 outline-white/10" />
                        </div>
                        <div class="ml-3">
                            <div class="text-base/5 font-medium text-white">Yuri</div>
                            <div class="text-sm font-medium text-gray-400">yurivolkov@example.com</div>
                        </div>
                        <button type="button"
